...
<body>
    ...
    <div class="table-layout">
        <form method= "post" action="/jwbook/studentControl?action=insert" name="join_form" >
            <table>
                <tbody>
            ...
            <div class="box-layout">
                ...
                <button type="submit" class="btn-layout" onclick="return checkForm()">입력</button>
           
        </form>
        <button class="btn-layout btn-layoutSec" onclick="deleteForm()">취소</button>
